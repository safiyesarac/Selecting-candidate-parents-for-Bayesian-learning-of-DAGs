...
cdef extern from "aps-0.9.1/aps/simple_modular.cpp" namespace "aps":
    void setAPSdebug(bool value)

def enable_aps_debug(flag=True):
    """
    Python function to enable or disable the debug logs in simple_modular.cpp
    """
    setAPSdebug(flag)
...
cdef extern from "aps-0.9.1/aps/bruteforce.cpp" namespace "aps":
    Array[Array[LogDouble]] modularAPS_bruteforce(Array[Array[LogDouble]] & w, bool test)

def aps(weights, as_dict=False, normalize=True):
